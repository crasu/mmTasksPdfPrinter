...
var getIssueInfo = function (text, projectName, jiraTaskId, callback) {
  var lines = text.split('\n'),
      issueInfo = '<p class="issueInfo">' + projectName + '-' + jiraTaskId + ': ',
      issueText,
      taskStatus,
      taskAssignee;
  var i;
      ...
      async.waterfall([
        ...
        function (data, cb) {
          ...
          if(output.match(/Issue key/m) && output.match(/Summary/m)) {
            getIssueInfo(output, jiraConfig.projectName, jiraTaskId, cb);
          }
        }
      ], callback);
    } else if (typeof callback === 'function') {
